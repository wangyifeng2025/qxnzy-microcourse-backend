...
-- 视频：按章节排序
CREATE INDEX IF NOT EXISTS idx_videos_chapter_sort ON videos (chapter_id, sort_order);

-- 转码：按视频和状态查询
CREATE INDEX IF NOT EXISTS idx_video_transcodes_video_status ON video_transcodes (video_id, status);
...
-- 视频问答点：按视频和触发时间排序
CREATE INDEX IF NOT EXISTS idx_video_questions_video_position ON video_questions (video_id, position_seconds);